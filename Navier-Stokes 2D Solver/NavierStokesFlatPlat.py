...
while not converged and t <= MAXIT:
    ...
    rho[1:num_y - 1, 1:num_x - 1], u[1:num_y - 1, 1:num_x - 1], v[1:num_y - 1, 1:num_x - 1], \
    T[1:num_y - 1, 1:num_x - 1] = U2Primitive(U1[1:num_y - 1, 1:num_x - 1], U2[1:num_y - 1, 1:num_x - 1],
                                              U3[1:num_y - 1, 1:num_x - 1], U5[1:num_y - 1, 1:num_x - 1], c_v)
